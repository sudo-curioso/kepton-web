...
import { PencilLine, CalendarClock, BellRing } from 'lucide-react'
import { useCallback, useState } from 'react'
import type { LucideIcon } from 'lucide-react'
import ReminderEmulator from '@/components/ReminderEmulator'
...
const STEPS: Step[] = [
  {
    ...
    desc: 'Jot a title and a quick note, set the priority — no rigid fields, no friction.',
    icon: PencilLine,
  },
  {
    n: '02',
    title: 'Pick the perfect moment',
    desc: 'Dial in the exact time with a smooth wheel, then tap the day on a clean calendar.',
    icon: CalendarClock,
  },
  {
    n: '03',
    title: 'Get reminded, stay on track',
    desc: 'Your reminder lands in a tidy list and nudges you right when it matters.',
    icon: BellRing,
  },
]
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-4 text-base leading-relaxed text-neutral-400 sm:text-lg">
            Set a reminder in three taps — with a beautiful time picker and calendar that keep you
            on schedule.
          </p>
        </motion.div>
            ...
            <div className="relative mx-auto w-full max-w-[300px]">
              ...
              <div className="relative rounded-[2.75rem] border border-white/[0.10] bg-gradient-to-b from-white/[0.08] to-white/[0.02] p-2.5 shadow-[0_20px_70px_rgba(0,0,0,0.55),inset_0_1px_0_0_rgba(255,255,255,0.12)] backdrop-blur-xl">
                <div className="relative aspect-[368/816] w-full overflow-hidden rounded-[2.25rem] bg-[#0a0f0b]">
                  ...
                  />
                  <ReminderEmulator phase={phase} cycle={cycle} onAdvance={advance} />
                </div>
              </div>
