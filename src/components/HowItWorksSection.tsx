...
const STEPS: Step[] = [
  {
    ...
    desc: 'Brain-dump any task in seconds. Set a priority and when — today, this week, or later. No rigid setup, no friction.',
    icon: Brain,
  },
  {
    n: '02',
    title: 'Let AI break it down',
    desc: 'Tap AI Steps and watch an overwhelming task turn into small, doable micro-steps you can actually begin.',
    icon: Sparkles,
  },
  {
    n: '03',
    title: 'Focus and grow your forest',
    desc: 'Start a session and a tree grows as the ring fills. Every completed focus plants it in your forest.',
    icon: TreePine,
  },
]
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-4 text-base leading-relaxed text-neutral-400 sm:text-lg">
            No setup. No learning curve. Tap a step to watch it happen — live, rendered in real time.
          </p>
        </motion.div>
            ...
            <div className="relative mx-auto w-full max-w-[300px]">
              ...
              <div className="relative rounded-[2.75rem] border border-white/[0.10] bg-gradient-to-b from-white/[0.08] to-white/[0.02] p-2.5 shadow-[0_20px_70px_rgba(0,0,0,0.55),inset_0_1px_0_0_rgba(255,255,255,0.12)] backdrop-blur-xl">
                <div className="relative aspect-[368/816] w-full overflow-hidden rounded-[2.25rem] bg-[#0a0f0b]">
                  ...
                  />
                  <AppEmulator phase={phase} cycle={cycle} onAdvance={advance} />
                </div>
              </div>
