...
import { Gauge, NotebookPen, Sparkles } from 'lucide-react'
import { useCallback, useState } from 'react'
import type { LucideIcon } from 'lucide-react'
import PlannerEmulator from '@/components/PlannerEmulator'
...
const STEPS: Step[] = [
  {
    n: '01',
    title: 'Tune in to your energy & mood',
    desc: 'Tell Kepton how you feel today — your plan adapts to your energy, not a rigid template.',
    icon: Gauge,
  },
  {
    n: '02',
    title: 'Add deadlines and context',
    desc: 'Drop in a deadline and whatever’s on your mind. No perfect wording required.',
    icon: NotebookPen,
  },
  {
    n: '03',
    title: 'Get a personalized plan — offline',
    desc: 'One tap turns your tasks into a realistic, time-blocked schedule, built privately on-device.',
    icon: Sparkles,
  },
]
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/4 top-0 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-emerald-600/6 blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 h-[360px] w-[360px] translate-x-1/2 rounded-full bg-emerald-500/5 blur-[100px]" />
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-4 text-base leading-relaxed text-neutral-400 sm:text-lg">
            Kepton turns how you feel and what’s on your plate into a realistic daily plan — built
            privately, right on your device.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          {/* Left — phone mockup with live emulation */}
          <motion.div
            ...
            <div className="relative mx-auto w-full max-w-[300px]">
              ...
              <div className="relative rounded-[2.75rem] border border-white/[0.10] bg-gradient-to-b from-white/[0.08] to-white/[0.02] p-2.5 shadow-[0_20px_70px_rgba(0,0,0,0.55),inset_0_1px_0_0_rgba(255,255,255,0.12)] backdrop-blur-xl">
                <div className="relative aspect-[368/816] w-full overflow-hidden rounded-[2.25rem] bg-[#0a0f0b]">
                  ...
                  />
                  <PlannerEmulator phase={phase} cycle={cycle} onAdvance={advance} />
                </div>
              </div>

              {/* Side buttons */}
              <div aria-hidden className="absolute -right-0.5 top-28 h-12 w-0.5 rounded-full bg-white/[0.10]" />
              <div aria-hidden className="absolute -left-0.5 top-24 h-8 w-0.5 rounded-full bg-white/[0.10]" />
              <div aria-hidden className="absolute -left-0.5 top-36 h-14 w-0.5 rounded-full bg-white/[0.10]" />
            </div>
          </motion.div>
